                                        ...
                                        <form action="{{route('patients.store')}}" method="POST">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input type="text" class="form-control" id="hospitalName"
                                                   ...
                                                   <span class="text-red">    @error('patient_name')    {{$message}} @enderror </span>
                                            </div>
                                            {{-- <div class="col-sm-6">
                                                <label for="hospitalName">الرقم التسلسلي </label>
                                                <input type="text" class="form-control" name="patient_code" placeholder="الرقم التسلسي ">
                                            </div> --}}
                                            ...
                                            <div class="col-sm-6" ><br>
                                                ...
                                                <input type="text" class="form-control" id="hospitalName"
                                               name="case" placeholder="الحالة ">
                                               <span class="text-red">    @error('case')    {{$message}} @enderror </span>
                                            </div>
