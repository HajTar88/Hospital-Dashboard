                                ...
                                <div class="card-body">
                                    <div class="tab-content p-0">
                                        ...
                                        <form action="{{route('wards.store')}}" method="POST">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    <label for="hospitalName">رقم العنبر</label>
                                                    <input type="text" class="form-control" name="ward_code" placeholder="رقم العنبر  ">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="hospitalName"> عنوان العنبر</label>
                                                    <input type="text" class="form-control" name="address" placeholder="عنوان العنبر ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <a href="{{route('wards.index')}}" class="btn btn-danger">الغاء <i
