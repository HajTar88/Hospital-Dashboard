        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
               ...
               <ul class="nav nav-treeview">
                ...
                <ul class="nav nav-treeview">
                  <a href="{{route('wards.index')}}" class="nav-link active">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">
                  ...
                  <a href="{{route('wards.create')}}"><button class="btn btn-success">اضـــــافة عنبر</button></a>
                </h3>
                        ...
                        <tbody class="text-center">
                         ...
                         @endphp
                          ...
                          <tr>
                            ...
                            <td>{{$item->beds}}</td>
                            <td>
                              <button type="button" class="btn btn-light"><a href="{{ route('wards.show', $item->id)}}" ><i class="bi bi-eye-fill"></i></a> </button>
                              <button type="button" class="btn btn-light"> <a href="{{url('modifyw/'.$item->id)}}" ><i class="far fa-edit text-success" ></i></a></button>
                              <button type="button" class="btn btn-light"> <a href="{{url('deletew/'.$item->id)}}" class="delete-confirm"><i class="fa fa-trash text-danger"></i></a>  </button>
                            </td>
                          </tr>
                          @endforeach
