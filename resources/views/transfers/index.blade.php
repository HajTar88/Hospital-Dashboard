            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">
                  ...
                  <a href="{{route('transfers.create')}}"><button class="btn btn-success">اضـــــافة تحويل</button></a>
                  <a href="{{route('transfersreq')}}"><button class="btn btn-success">طلبات التحويل</button></a>
                </h3>
              </div><!-- /.card-header -->
              <div class="container">
