                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col" >
                                                    ...
                                                    <select id="hospitalName" name="current_hospital" value="{{$transfer->current_hospital}}">
                                                      <option
                                                      value="مستشفى  علياء" >مستشفى علياء </option>
                                                      <option
                                                        value="مستشفى العالمي" >مستشفى العالمي </option>
                                                        <option
                                                        value="مستشفى رويال كير" >مستشفى  رويال كير</option>
                                                    </select>
                                                </div>
