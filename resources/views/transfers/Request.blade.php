  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">aaaa
        {{-- {{$transfers->address}} --}}
    </span>
    </a>
{{-- @foreach ($transfers as $item)
<p>{{$item->hospital_referred}}</p>
@endforeach --}}
    <!-- Sidebar -->
    <div class="sidebar">
                         ...
                         @endphp
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-light"> <a href="{{url('transfersrrej/'.$item->id)}}" ><i class="bi bi-x text-danger"></i></a></button>
                              <button type="button" class="btn btn-light"> <a href="{{url('transfersracc/'.$item->id)}}"><i class="bi bi-check2  text-success"></i></a>  </button>
                            </td>
                          </tr>
                          @endforeach
