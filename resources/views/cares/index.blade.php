            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">
                  ...
                  <a href="{{route('cares.create')}}"><button class="btn btn-success">اضـــــافة عناية</button></a>
                </h3>
                        ...
                        <tbody class="text-center">
                         ...
                         @endphp
                          ...
                          <tr>
                            ...
                            <td>{{$item->care_code}}</td>
                            <td>{{$item->address}}</td>
                            <td>{{$item->beds}}</td>
                            <td>
                              <button type="button" class="btn btn-light"><a href="{{ route('cares.show', $item->id)}}" ><i class="bi bi-eye-fill"></i></a> </button>
                              <button type="button" class="btn btn-light"> <a href="{{url('modifyc/'.$item->id)}}" ><i class="far fa-edit text-success" ></i></a></button>
                              <button type="button" class="btn btn-light"> <a href="{{url('deletec/'.$item->id)}}" class="delete-confirm"><i class="fa fa-trash text-danger"></i></a>  </button>
                            </td>
                          </tr>
                          @endforeach
