                                        ...
                                        <form action="{{route('cares.store')}}" method="POST">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="care_code" placeholder="رقم العناية ">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="hospitalName"> عنوان العناية</label>
                                                    <input type="text" class="form-control" name="address" placeholder="عنوان العناية ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <a href="{{route('cares.index')}}" class="btn btn-danger">الغاء <i
