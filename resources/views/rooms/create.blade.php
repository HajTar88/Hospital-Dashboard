                                        ...
                                        <form action="{{route('rooms.store')}}" method="POST">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="room_code" placeholder="رقم الغرفة ">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="hospitalName"> عنوان الغرفة</label>
                                                    <input type="text" class="form-control" name="address" placeholder="عنوان الغرفة ">
