                                        ...
                                        <form action="{{route('nurseries.store')}}" method="POST">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="nurserie_code" placeholder="رقم الحضانة ">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="hospitalName"> عنوان الحضانة</label>
                                                    <input type="text" class="form-control" name="address" placeholder="عنوان الحضانة ">
