        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
               ...
               <ul class="nav nav-treeview">
                ...
                <ul class="nav nav-treeview">
                  <a href="{{route('nurseries.index')}}" class="nav-link active">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">
                  ...
                  <a href="{{route('nurseries.create')}}"><button class="btn btn-success">اضـــــافة حضانة</button></a>
                </h3>
                    ...
                    <table class="table table-bordered">
                        <thead class="text-center">
                          <tr>
                            ...
                            <th scope="col">رقم الحضانة</th>
                            <th scope="col">العنوان </th>
                            <th scope="col">عدد الأسرة</th>
                        ...
                        <tbody class="text-center">
                          ...
                          $i = 0 ;
                         @endphp
                          @foreach ($nurseries as $item)
                          <tr>

                            <td>{{$item->nurserie_code}}</td>
                            <td>{{$item->address}}</td>
                            <td>{{$item->beds}}</td>
                            <td>
                              <button type="button" class="btn btn-light"><a href="{{ route('nurseries.show', $item->id)}}" ><i class="bi bi-eye-fill"></i></a> </button>
                              <button type="button" class="btn btn-light"> <a href="{{url('modifyn/'.$item->id)}}" ><i class="far fa-edit text-success" ></i></a></button>
                              <button type="button" class="btn btn-light"> <a href="{{url('deleten/'.$item->id)}}" class="delete-confirm"><i class="fa fa-trash text-danger"></i></a>  </button>
                            </td>
                          </tr>
                          @endforeach
