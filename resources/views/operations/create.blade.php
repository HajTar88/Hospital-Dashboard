                                ...
                                <div class="card-body">
                                    <div class="tab-content p-0">
                                        ...
                                        <form action="{{route('operations.store')}}" method="POST">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    <label for="hospitalName">رقم غرفة العمليـــــات</label>
                                                    <input type="text" class="form-control" name="operation_code" placeholder="رقم غرفة العمليـــــات">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="hospitalName"> عنوان غرفة العمليات</label>
                                                    <input type="text" class="form-control" name="address" placeholder="عنوان غرفة العمليات ">
                                                    <span class="text-red">    @error('address')    {{$message}} @enderror </span>
                                                </div>
                                                <div class="col">
                                                    <label for="hospitalName">  عدد الأسرة</label>
                                                    <input type="text" class="form-control" name="beds" placeholder=" عدد الأسرة">
                                                    <span class="text-red">    @error('beds')    {{$message}} @enderror </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <button type="submit" class="btn btn-primary">اضـــــافة <i
                                                            class="bi bi-plus-circle"></i></button>
                                                </div>
                                                <div class="col">
                                                    <a href="{{route('operations.index')}}" class="btn btn-danger">الغاء <i
