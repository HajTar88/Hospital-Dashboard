      ...
      <nav class="mt-2" >
        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
                 <a href="{{route('operations.index')}}" class="nav-link active">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">
                  ...
                  <a href="{{route('operations.create')}}"><button class="btn btn-success">اضـــــافة غرفة عمليات</button></a>
                </h3>
                    ...
                    <table class="table table-bordered">
                        <thead class="text-center">
                          <tr>
                            ...
                            <th scope="col">رقم غرفة العمليـــــات</th>
                        ...
                        <tbody class="text-center">
                         ...
                         @endphp
                          ...
                          <tr>
                            ...
                            <td>{{$item->beds}}</td>
                            <td>
                              <button type="button" class="btn btn-light"><a href="{{ route('operations.show', $item->id)}}" ><i class="bi bi-eye-fill"></i></a> </button>
                              <button type="button" class="btn btn-light"> <a href="{{url('modifyo/'.$item->id)}}" ><i class="far fa-edit text-success" ></i></a></button>
                              <button type="button" class="btn btn-light"> <a href="{{url('deleteo/'.$item->id)}}" class="delete-confirm"><i class="fa fa-trash text-danger"></i></a>  </button>
                            </td>
                          </tr>
                          @endforeach
